...
def index():
    ...
    button_html = Markup(f'<button class="{button_class}">{button_text}</button>')
...
@app.route('/')
def index():
    button_html = Markup('<button onclick="send_message(\'Concepto\')">Concepto</button>')
    return render_template('index.html', button_html=button_html)
...
def index():
    buttons = [
        Markup('<button onclick="send_message(\'Concepto\')">Concepto</button>'),
        Markup('<button onclick="send_message(\'Ejemplo\')">Ejemplo</button>'),
        Markup('<button onclick="send_message(\'Ayuda\')">Ayuda</button>')
    ]
...
_______________________HTML__________________________

<!DOCTYPE html>
<html>
  <head>
    <title>Botones con Flask</title>
  </head>
  <body>
    <h1>Botones con Flask</h1>
...
<html>
  <head>
    <title>Botón con párrafo en Flask</title>
  </head>
  <body>
    <h1>Botón con párrafo en Flask</h1>
...
def index():
    ...
    return render_template('index.html', button_text=button_text, paragraph_text=paragraph_text)
